...
\begin{tcolorbox}
\paragraph{Przykład --- wektory ekspertów.}
Załóżmy, że liczność zbioru umiejętności $S$ jest równa 5. Wówczas ponumerujemy umiejętności rozważane w~problemie liczbami z zakresu $[1, 5]$.

Pewien ekspert ze~zbioru $E$ posiada umiejętności 2, 3 i~5. Wówczas wektor opisujący jego umiejętności to:
$$[0, 1, 1, 0, 1]$$
\end{tcolorbox}
...
\begin{tcolorbox}
\paragraph{Przykład --- wektory zapotrzebowania projektów.}
...
\begin{tcolorbox}
\paragraph{Przykład --- obliczanie liczby braków.}
...
\begin{align*}
[1, 0, 1, 0, 1] & \qquad (\text{wykorzystuje }1) \\
[1, 0, 0, 0, 1] & \qquad (\text{wykorzystuje }1) \\
[1, 1, 0, 1, 0] & \qquad (\text{wykorzystuje }4) \\
[0, 0, 0, 1, 1] & \qquad (\text{wykorzystuje }4)
\end{align*}
