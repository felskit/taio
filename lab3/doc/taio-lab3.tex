...
\paragraph{Sprawdzenie poprawności rozwiązania}
...
\paragraph{Podział na~podproblemy}
...
\paragraph{Ocena pojedynczego podproblemu}
...
\paragraph{Ostateczna ocena}
całego rozwiązania jest równa sumie oceny wyznaczonych podproblemów.\\
