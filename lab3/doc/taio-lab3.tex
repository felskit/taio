...
\vspace{0.5em}
\noindent
Przeszukiwanie wszerz jest sposobem przeglądania grafu zaproponowanym przez Edmondska i Karpa w swoim algorytmie będącym implementacją metody Forda-Fulkersona.

\subsubsection{Wyznaczanie przepływu maksymalnego - TODO FIX}
