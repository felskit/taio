...
\vspace{0.5em}
\noindent
Przeszukiwanie wszerz jest używane do konstrukcji ścieżek powiększających w algorytmie Edmondsa-Karpa, stosującym metodę Forda-Fulkersona wyznaczania przepływu maksymalnego.
