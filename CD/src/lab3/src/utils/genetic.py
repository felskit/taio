...
class GeneticSolver:
    ...
    def solve(self):
        ...
        while True:
            ...
            if current_best_solution and current_best_solution[0] >= 0 and \
                    (not best_solution or best_solution[0] < 0 or current_best_solution and
                     best_solution[0] > current_best_solution[0] > 0):
